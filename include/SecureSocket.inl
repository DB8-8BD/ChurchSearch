...
inline bool CSecureEvtSyncSocket::Connect(LPCTSTR szAddr, unsigned short nPort) 
{
	...
	{
		bRet = Connect((const addrinfo*)address.GetAddrInfo());
	}
...
inline bool CSecureEvtSyncSocket::createCredentials()
{
    ...
    Status = g_Sample_SecurityInit._SecurityFunc.AcquireCredentialsHandle(
							...
							SecBuffer *     pExtraData)     // out
{
    ...
    scRet = g_Sample_SecurityInit._SecurityFunc.InitializeSecurityContext(
                    &m_hClientCreds,
                    NULL,
...
inline void CSecureEvtSyncSocket::getNewClientCredentials()
{
    ...
    Status = g_Sample_SecurityInit._SecurityFunc.QueryContextAttributes(&m_hContext,
									...
									DWORD           dwCertFlags)
{
    ...
    polHttps.pwszServerName     = (WCHAR*)pszServerName;
...
inline bool CSecureEvtSyncSocket::Write(WSABUF *pBuffers, int nCount, DWORD *pdwSize) 
{
    ...
    scRet = g_Sample_SecurityInit._SecurityFunc.QueryContextAttributes(&m_hContext,
...
inline bool CSecureEvtSyncSocket::Read(const unsigned char *pBuff, DWORD *pdwSize) 
{
	...
	volatile unsigned int			iReads = 0;
    //
    // Read stream encryption properties.
    //
    scRet = g_Sample_SecurityInit._SecurityFunc.QueryContextAttributes(&m_hContext,
...
inline bool CSecureEvtSyncSocket::disconnectFromSecureServer()
{
    ...
    Status = g_Sample_SecurityInit._SecurityFunc.InitializeSecurityContext(
                    &m_hClientCreds,
                    &m_hContext,
                    NULL,
                    dwSSPIFlags,
